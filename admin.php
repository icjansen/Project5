        ...
        <form action="" method="post">
            ...
            if(isset($_POST['search_users'])){
                ...
                while($row2=mysqli_fetch_array($result2)){
                    ?>
                    <input type="text" name="username" value="<?php echo $row2['username'];?>" placeholder="Gebruikersnaam">
                    <input type="text" name="first_name" value="<?php echo $row2['first_name'];?>" placeholder="Voornaam">
                    <input type="text" name="last_name" value="<?php echo $row2['last_name'];?>" placeholder="Achternaam">
                    <input type="text" name="street" value="<?php echo $row2['address'];?>" placeholder="Straat">
                    <input type="number" name="housenumber" value="<?php echo $row2['housenumber'];?>" placeholder="Huisnummer">
                    ...
                    <input type="number" name="phonenumber" value="0<?php echo $row2['phonenumber'];?>" placeholder="Telefoonnummer">
                    <input type="checkbox" name="newsletter" placeholder="Nieuwsbrief" <?php if($row2['newsletter']==1){ echo 'checked="checked"';}?>>
